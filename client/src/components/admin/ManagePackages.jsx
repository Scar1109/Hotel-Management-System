...
function ManagePackages() {
        ...
        const filteredPackages = packages.filter((pkg) => {
                return (
                        pkg.packageName
                                .toLowerCase()
                                .includes(searchText.toLowerCase()) || // Filter by package name
                        pkg.description
                                .toLowerCase()
                                .includes(searchText.toLowerCase()) || // Filter by description
        ...
        const columns = [
                ...
                },
                {
                        ...
                        key: "createdAt",
                        sorter: (a, b) =>
                                new Date(b.createdAt) - new Date(a.createdAt), // Sort by createdAt in descending order
        ...
        let totalPackages = 0;
        let bookedPackages = 0;
        let unbookedPackages = 0;
        let barChartData = {};
        let pieChartData = {};
        ...
        if (Array.isArray(bookingData)) {
                ...
                bookedPackages = bookingData.length;
                unbookedPackages = totalPackages - bookedPackages;
                barChartData = {
                        ...
                        datasets: [
                                {
                                        ...
                                        maxBarThickness: 50, // Limit maximum bar thickness
                                },
                        ],
                };
                        ...
                        <div className="manage_packages_content">
                                <div className="manage_packages_header">
                                        ...
                                        <div className="search-container-122313">
                                                ...
                                                <button
                                                        className="add_new_package"
                                                        onClick={showModal}
                                                >
                                                        Add Package
                                                </button>
                                                <button
                                                        className="download_pkg"
                                                        onClick={downloadCSV}
                                                >
                                                        Download CSV
                                                </button>
                                                ...
                                                >
                                                        <Form.Item
                                                                ...
                                                                rules={[
                                                                        {
                                                                                required: true,
                                                                                message: "Please enter the package Image URL",
                                                                        },
                                                                ]}
                                                        >
