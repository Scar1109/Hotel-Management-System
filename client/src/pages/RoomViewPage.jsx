...
function RoomViewPage() {
      ...
      const handleChange = (values) => {
            const selected = packages.filter((pkg) => values.includes(pkg._id));
      ...
      const onDateChange = (dates) => {
            if (dates && dates.length === 2) {
                  ...
                  const newTotalPrice = room.price * nights + additionalPrice;
      ...
      return (
            <div className="room-details-page">
                  ...
                  <div className="room-info">
                        <h1>
                              {room.roomType} <span>{room.size} Person</span>
                        </h1>
                        ...
                        <p className="cancellation-rules">
                              ...
                              <br />
                              After <strong>{partialRefundDate}</strong>:{" "}
                              <span>50% refund.</span>
                        </p>
